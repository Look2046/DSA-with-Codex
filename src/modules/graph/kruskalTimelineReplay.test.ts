...
import { buildKruskalTimelineFromPreset } from './kruskalTimelineAdapter';
...
function runReplaySequence(speedMs: number): {
  ...
  const frames = buildKruskalTimelineFromPreset('mstUndirected');
...
describe('kruskal timeline deterministic replay', () => {
