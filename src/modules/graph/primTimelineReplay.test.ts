...
import { buildPrimTimelineFromPreset } from './primTimelineAdapter';
...
function runReplaySequence(speedMs: number): {
  ...
  const frames = buildPrimTimelineFromPreset('mstUndirected');
...
describe('prim timeline deterministic replay', () => {
