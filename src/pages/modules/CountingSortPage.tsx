...
const PAGE_COPY = {
  en: {
    ...
    code: [
      ...
      'scan right to left: output[count[key]-1] = value, then count[key] -= 1',
  ...
  zh: {
    ...
    code: [
      ...
      '从右向左扫描：写入 output[count[key]-1]，再令 count[key] -= 1',
      '输出数组即为有序结果',
    ],
  },
} as const;
    ...
    <WorkspaceShell
      ...
      controlsContent={
        <>
          ...
          <label className="tree-workspace-field" htmlFor="speed-select-CountingSortPage">
            <span>{t('module.s01.speed')}</span>
            <select
              id="speed-select-CountingSortPage"
              value={speedMs}
