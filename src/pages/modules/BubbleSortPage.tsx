...
export function BubbleSortPage() {
  ...
  return (
    <WorkspaceShell
      ...
      controlsContent={
        <>
          <label className="tree-workspace-field" htmlFor="dataset-size">
          ...
          <label className="tree-workspace-field" htmlFor="speed-select-BubbleSortPage">
            <span>{t('module.s01.speed')}</span>
            <select
              id="speed-select-BubbleSortPage"
              value={speedMs}
        ...
        <div className="workspace-panel-scroll">
          ...
          <div className="pseudocode-block">
            ...
            <ol>
              ...
              <li className={currentSnapshot?.codeLines.includes(6) ? 'code-active' : ''}>{t('module.s01.code.line6')}</li>
