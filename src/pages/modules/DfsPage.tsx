            ...
            <section className="graph-stage-canvas-panel">
              ...
              <svg className="graph-edge-layer" viewBox="0 0 100 100" preserveAspectRatio="none">
                <defs>
                  ...
                  <marker
                    id="graph-dfs-edge-arrow-active"
                    markerWidth="8"
                    markerHeight="8"
                    refX="7"
                    refY="4"
                    ...
                    <line
                      ...
                      markerEnd={
                        graph.topology === 'directed'
                          ? isActive
                            ? 'url(#graph-dfs-edge-arrow-active)'
                            : 'url(#graph-dfs-edge-arrow)'
                          : undefined
                      }
                    />
                  );
            ...
            <div className="graph-stage-views">
              <section className="graph-stage-view-card">
                <div className="graph-stage-view-head">
                  ...
                  <span>{t('module.g02.view.adjacencyHint')}</span>
                </div>
              ...
              <section className="graph-stage-view-card">
                <div className="graph-stage-view-head">
                  ...
                  <span>{t('module.g02.view.stateHint')}</span>
                </div>
