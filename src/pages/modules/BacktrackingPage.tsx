...
const PAGE_COPY = {
  en: {
    ...
    code: [
      ...
      'undo the queen and try the next candidate column',
      'when every branch has been explored, stop',
    ],
  },
  zh: {
    title: 'P-04 回溯',
    ...
    <WorkspaceShell
      ...
      controlsContent={
        <>
          ...
          <label className="tree-workspace-field" htmlFor="speed-select-BacktrackingPage">
            <span>{t('module.s01.speed')}</span>
            <select
              id="speed-select-BacktrackingPage"
              value={speedMs}
