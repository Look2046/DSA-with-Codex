...
export function GeneralizedListHeadTailPage() {
  ...
  return (
    <StaticWorkbenchShell
      title={t('module.m07.title')}
      description={t('module.m07.body')}
      stageAriaLabel={t('module.m07.stage')}
      pageClassName="array-page tree-page storage-page generalized-list-page"
