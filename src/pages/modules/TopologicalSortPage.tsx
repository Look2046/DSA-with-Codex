    ...
    <WorkspaceShell
      ...
      controlsContent={
        <>
          ...
          <label className="tree-workspace-field" htmlFor="speed-select-TopologicalSortPage">
            <span>{t('module.s01.speed')}</span>
            <select
              id="speed-select-TopologicalSortPage"
              value={speedMs}
            ...
            <section className="graph-stage-canvas-panel">
              <svg className="graph-edge-layer" viewBox="0 0 100 100" preserveAspectRatio="none">
                {graph.edges.map((edge) => {
                  ...
                  const geometry = getGraphStageEdgeGeometry(from, to, true);
                  ...
                  const arrowClassName = `graph-edge-outline-arrow${
                    isInspected ? ' graph-edge-outline-arrow-completed' : ''
                  }${fromProcessed ? ' graph-edge-outline-arrow-selected' : ''}${
                  ...
                  return (
                    <g key={edgeKey}>
                      <path
                        ...
                        d={geometry.path}
                      />
                      <path className={arrowClassName} d={geometry.arrowPath} />
                    </g>
                  );
                })}
              </svg>
