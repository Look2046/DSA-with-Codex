    ...
    <WorkspaceShell
      ...
      controlsContent={
        <>
          ...
          <label className="tree-workspace-field" htmlFor="speed-select-FloydWarshallPage">
            <span>{t('module.s01.speed')}</span>
            <select
              id="speed-select-FloydWarshallPage"
              value={speedMs}
                ...
                {graph.edges.map((edge) => {
                  ...
                  return (
                    <g key={edgeKey}>
                      ...
                      />
                      <path
                        className={`graph-edge-outline-arrow${isActive ? ' graph-edge-outline-arrow-active' : ''}`}
